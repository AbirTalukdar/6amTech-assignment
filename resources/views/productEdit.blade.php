...
<form id="productStoreId" class="form" novalidate="">
    ...
    <div class="card-title">
        <h2 class="mr-2"><span>Update Product</h2>
    </div>
    <input type="text" id="id" name="id" value="{{$product ? $product->id : ''}}" hidden>
                <div class="row">
                  <div class="col">
                    <div class="row">
                      <div class="col">
                ...
                <div class="row">
                  <div class="col d-flex justify-content-end">
                    <button class="btn btn-primary" type="button" onClick='store()'>Update Product</button>
                  </div>
                </div>
              </form>
</div>
